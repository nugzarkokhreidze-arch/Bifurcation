            ...
            <div className="flex max-h-[48dvh] min-h-[220px] w-full items-center justify-center overflow-hidden rounded-2xl border bg-black sm:max-h-[60vh] sm:min-h-[240px]">
              {fullscreenMedia.type === 'tiktok' && fullscreenMedia.url && (
                (() => {
                  ...
                  if (videoId) {
                    return (
                      <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-black p-2">
                        <iframe
                          src={`https://www.tiktok.com/embed/v2/${videoId}`}
                          title="TikTok video"
                          allow="fullscreen"
                          className="h-[400px] w-full max-w-md border-0 bg-black sm:h-[500px]"
                        />
                        <a
                          href={cleanUrl}
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2 text-[11px] font-black text-slate-950"
                        >
