  ...
  return (
    <section className="mx-auto max-w-5xl space-y-6 sm:space-y-8">
        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-violet-100">
              „ბიფურკაცია“ არის სივრცითი პროვოკაციული გამოწვევა — სოციალური თამაში, სადაც
              „არასტანდარტული ქმედებებით“ აგროვებ ქულებს, აზიარებ TikTok-ზე შესრულებულ
              დავალებებს, იღებ მხარდაჭერას და იბრძვი წოდებისთვის: „მე ვარ საუკეთესო“.
              ეს არის კოლექტიური თამაში, სადაც ბევრი ადამიანი გეხმარება შენ, და შენც
              ეხმარები სხვებს — უსაფრთხო, შემოქმედებითი და სახალისო გამოწვევებით
              დაძლიოთ ბარიერები, შიშები და კომპლექსები.
            </p>
          </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-[1.75rem] border border-violet-100 bg-white p-5 shadow-sm sm:p-6">
          <div className="mb-4 inline-flex rounded-2xl bg-violet-100 px-3 py-2 text-xl text-violet-700">
            🔀
          </div>
          <h3 className="text-xl font-black text-slate-950">რას ნიშნავს ბიფურკაცია?</h3>
          <p className="mt-4 text-sm leading-7 text-slate-600">
            ბიფურკაცია ნიშნავს გარდატეხის წერტილს — მომენტს, როცა სისტემა, ადამიანი
            ან სიტუაცია ძველ გზაზე ვეღარ რჩება და მის წინ რამდენიმე ახალი მიმართულება
            იხსნება. ასეთ დროს მცირე გადაწყვეტილებასაც შეუძლია შეცვალოს შემდეგი გზა:
            ერთი არჩევანი გვტოვებს კომფორტის ზონაში, მეორე კი გვაძლევს ზრდის,
            გამბედაობისა და ახალი გამოცდილების შესაძლებლობას.
          </p>
        </div>

        <div className="rounded-[1.75rem] border border-fuchsia-100 bg-gradient-to-br from-fuchsia-50 via-white to-amber-50 p-5 shadow-sm sm:p-6">
          <div className="mb-4 inline-flex rounded-2xl bg-fuchsia-100 px-3 py-2 text-xl text-fuchsia-700">
            ⚡
          </div>
          <h3 className="text-xl font-black text-slate-950">რას ნიშნავს ეს თამაშის გაგებით?</h3>
          <p className="mt-4 text-sm leading-7 text-slate-600">
            ამ თამაშში ბიფურკაცია არის არჩევანი: ავარიდო თავი გამოწვევას, თუ უსაფრთხოდ
            ვცადო ახალი მოქმედება და დავინახო, რა შემიძლია. თითოეული დავალება არის
            პატარა გზაგასაყარი — მოთამაშე ირჩევს მოქმედებას, აზიარებს TikTok proof-ს,
            იღებს რეალურ ჩართულობას და აგროვებს ქულებს. ქულები არ ზომავს ადამიანის
            ღირებულებას; ისინი მხოლოდ თამაშის პროცესში გამბედაობას, მონაწილეობას და
            აქტიურობას ასახავს.
          </p>
        </div>
      </div>
        ...
        <div className="rounded-3xl border border-violet-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 space-y-4 text-sm leading-7 text-slate-600">
            <p>
              ...
              „თაობათა დიალოგი“. RICDOG მუშაობს
              ახალგაზრდების განვითარებაზე, საზოგადოებრივ მონაწილეობაზე,
              მშვიდობის კულტურაზე და შემოქმედებით განათლებაზე.
            </p>

            <p>
              „ბიფურკაცია“ აერთიანებს თამაშის, სოციალური მედიის, კოლექტიური მხარდაჭერისა
              და თვითგამოხატვის ელემენტებს. მისი მიზანია, მონაწილეებს მისცეს
              უსაფრთხო სივრცე არასტანდარტული, შემოქმედებითი ქმედებებით საკუთარი
              შესაძლებლობების გამოცდისთვის, ბარიერების დაძლევისთვის და პოზიტიური
              სოციალური ჩართულობისთვის.
            </p>
